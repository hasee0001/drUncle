...
import AppointmentForm from '../components/form/AppointmentForm.jsx';
  ...
  return <>
            ...
            <div>
              <div className='lg:w-[570px]'>
                <h1 className='text-[36px] leading-[46px] text-headingColor font-[800] md:text-[60px] md:leading-[70px]'>
                  Where expertise meets empathy, healing becomes a precise and compassionate science

                </h1>
                <br />
                <p className='text__para'>There is an old saying of “What do you call the person who finishes last in his class in medical
                  school?” The answer is “MD”. Anyone who finishes medical school is going to get a job and that job
                  is going to pay pretty well. The lowest paid doctor in your hospital is still making a
                  higher-than-middleclass salary. Even if a doctor loses their job, because the practice closes or
                  because they don’t get along with the other partners, they can find another job somewhere in just
                  days.</p>

                <button className='btn' onClick={handleRequestAppointment}>
                  Request an Appointment
                </button>

                {/* Render the AppointmentForm when the button is clicked */}
          ...
          <div className='py-[30px] px-5'>
            ...
            <div className="mt-[px]">
              ...
              <p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center'>
                World  care for everyone. Our Health System Offers unmatched, expert health care.
    ...
    {/* ============== Our great doctors ============== */}
      <section>
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            <h2 className='heading text-center m-5'> Our Professional Doctors </h2>
            <p className='text__para text-center mb-4'>
              Word-class care for everyone. Our health system offers unmatched, expert health care.
            </p>
          </div>
